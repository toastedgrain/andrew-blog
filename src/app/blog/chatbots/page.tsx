  ...
  return (
    <main className="max-w-2xl mx-auto px-6 py-12 bg-[#f8f8f3] min-h-screen">
      ...
      <article className="prose prose-xl font-serif text-xl space-y-5 text-gray-800 gap-y-8">
        <p>
          Recently, I built my own chatbot that works a lot like ChatGPT. It’s
          powered by Gemini PRO, though since I used the free version, there are
          some limitations. I also added a login feature through Google
          Firestore, which means the chatbot can store information for each user
          individually. That was something I really wanted because it makes the
          experience more personalized, and it also gave me some practice with
        ...
        <p>
          ...
          biggest projects I’ve worked on, and debugging took me hours on end. I
          eventually had to restructure the project so I could actually follow
          what was going on. Streamlit also had some limitations like not being
          able to handle multiple pages or anything complicated on the
